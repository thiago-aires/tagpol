function bubbleChart() {
	...
	height = 980,
	marginTop=20,
	minRadius = 10, //tamanho minimo pro raio
	maxRadius = 120, //tamanho maximo pro raio
	columnForColors = "nome",
	columnForTitle = "nome",
	columnForRadius = "tamanho",
	forceApart = -1200, // força que as bolhas vao se atrair (negativo se afasta, positivo se atrai)
	unitName="R$",
	customColors=false,
	customRange,
	customDomain,
	...
	function chart(selection) {
        ...
        //simulação de forças que irão atuar nas bolhas, x y e colisao
		...
		.on("mouseover", function(d) {
			tooltip.html(d[columnForTitle] + "<br/>" + d["valor"]);
